...
### Safety Note
This repository does not contain any malicious pcaps or files. However, the exercise files on malware-traffic-analysis.net should be considered malicious and treated accordingly. I will be completing these exercises inside of a Win10 VM provisioned with FLARE. No dynamic analysis will be conducted.
